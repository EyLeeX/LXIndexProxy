...
public class SearchMapper {
            ...
            for (Map.Entry<String, GroupQuery.RangeAgg<Number>[]> entry : numRangeAgg.entrySet()) {
                ...
                for (GroupQuery.RangeAgg<Number> range : entry.getValue()) {
                    ...
                    if (range.getStart() == null) {
                          ...
                          list.add(AggregationBuilders.range(name).addRange((double) range.getStart(), (double) range.getEnd()));
                    }
    ...
    private static List<AbstractAggregationBuilder> addGroup(List<AbstractAggregationBuilder> list, GroupQuery.Func func, String field) {
    ...
    private static void processAggResult(SearchResponse response, GroupQuery group, QueryResult result) {
